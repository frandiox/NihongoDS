...
TEXT1 := NihongoDS
TEXT2 := Entorno de Desarrollo Software
TEXT3 := ETSIIT Granada
...
BUILD       := build
SOURCES     := source data gfx/bin source/simbolo source/sprite source/interfaz source/otras
INCLUDES    := include build data gfx include/simbolo include/sprite source/ejemplos include/interfaz include/otras
AUDIO       := audio
RELEASEPATH := 
